...
static const op_t op[] = {
    ...
    {"add", 3, {T_REG, T_REG, T_REG}, ADD, 10, "addition", true, {false, false, false}},
    {"sub", 3, {T_REG, T_REG, T_REG}, SUB, 10, "soustraction", true, {false, false, false}},
    ...
    {"lld", 2, {T_DIR | T_IND, T_REG}, LLD, 10, "long load", true, {false, false}},
